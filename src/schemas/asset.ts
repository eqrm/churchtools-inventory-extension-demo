...
export const assetSchema = z
    .object({
        ...
        kitDisassemblyDate: isoTimestampSchema.nullable().optional(),
        kitBoundAssets: z.array(z.object({
            assetId: uuidSchema,
            assetNumber: z.string().min(1),
            name: z.string().min(1),
            inherits: z.record(z.string(), z.boolean()).optional(),
        })).optional(),
        kitPoolRequirements: z.array(z.object({
