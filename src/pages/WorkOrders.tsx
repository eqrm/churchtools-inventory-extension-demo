...
import { IconPlus, IconEdit, IconTable, IconColumns, IconTimeline, IconCalendar } from '@tabler/icons-react';
...
export function WorkOrders() {
  ...
  const handleFormSubmit = (data: Omit<WorkOrder, 'id' | 'createdAt' | 'updatedAt' | 'createdBy' | 'createdByName' | 'workOrderNumber' | 'history'>) => {
    if (selectedWorkOrder) {
      // TODO: Implement update when useUpdateWorkOrder hook is available
      handleFormClose();
    } else {
      ...
      createWorkOrder.mutate(
        {
          ...
          history: [],
          createdBy: '' as UUID, // Will be set by the service
        },
        {
          onSuccess: () => {
            handleFormClose();
                ...
                },
                {
                  label: (
                    <Group gap={5}>
                      ...
                      <span>{t('maintenance:workOrders.viewMode.calendar')}</span>
                    </Group>
                  ),
                  value: 'calendar',
                },
          ...
          <Group gap="sm">
            <Select
              ...
              data={[
                ...
                { label: t('maintenance:states.scheduled'), value: 'scheduled' },
